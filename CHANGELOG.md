...
- A resubscribe cut short by the socket dropping no longer sends a second `Err` to the consumer, restoring the documented one `Err` per disconnect ([#44](https://github.com/aursen-labs/spume/pull/44)).
